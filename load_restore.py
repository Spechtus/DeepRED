...
def load_bin_act_and_weights(name):
	...
	with open('binA/'+name+'act_test.pkl', 'rb') as f:
		act_test = pickle.load(f)
	with open('binA/'+name+'act_vali.pkl', 'rb') as f:
		act_vali = pickle.load(f)
	return (act_train, act_vali, act_test)
...
def save_vali_indexes(vali_indexes, dataset_name, split_name):
	with open('indexes/'+dataset_name+'_'+split_name+'_vali.pkl', 'wb') as f:
		pickle.dump(vali_indexes, f, pickle.HIGHEST_PROTOCOL)

def load_vali_indexes(dataset_name, split_name):
	with open('indexes/'+dataset_name+'_'+split_name+'_vali.pkl', 'rb') as f:
			vali = pickle.load(f)
	return vali
